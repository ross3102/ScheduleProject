...
function get_tasks_by_category_id($category_id) {
    ...
    $query = "select task_id, task_name, DATE_FORMAT(task_date, '%e %M, %Y') as form_date, DATE_FORMAT(task_date, '%c/%e/%Y') as task_date, task_completed
              from task_list_task
              where category_id = :category_id
...
function get_task_list($user_id) {
    ...
    $query = "select task_id, task_name, DATE_FORMAT(task_date, '%e %M, %Y') as form_date, DATE_FORMAT(task_date, '%c/%e/%Y') as task_date, task_completed, c.category_id, c.category_name
