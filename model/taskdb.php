...
function get_task_list($user_id) {
    ...
    $query = "select task_id, task_name, DATE_FORMAT(task_date, '%b %d, %Y') as form_date, DATE_FORMAT(task_date, '%m/%d/%y') as task_date_short, DATE_FORMAT(task_date, '%c/%e/%Y') as task_date, task_completed, c.category_id, c.category_name
